...
# scan the containers for vulnerabilities
print("Scanning containers for vulnerabilities with Anchor Engine...")
for container in containers_data:
    print(f"Scanning {container['Container Name']}...")
    # Scan the container for vulnerabilities
    try:
        ...
        for vulnerability in vulnerabilities:
            ...
            # Save the vulnerabilities to a text file
            with open("Anchore_engine_scan_result.txt", "a") as file:
                file.write(f"Vulnerabilities for {container['Container Name']}:\n")
                for vulnerability in vulnerabilities:
                    file.write("\n")
                    file.write(f"{vulnerability['vuln']}: {vulnerability['severity']}\n")
                file.write("\n")
            print(f"An error occurred while scanning {container['Container Name']}: {str(e)}")
