...
2. Run the program by running following file:
    ...
    python Main.py
    ```
3. in "Output" folder, you can see the files that containing the vulnerabilities of the services that were running in the provided url or docker network in .txt and .pdf style."some file provided for sample for running the program by yourself  
