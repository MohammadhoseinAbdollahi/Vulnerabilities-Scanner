...
1. Install these libraries :
    ...
    - `vulners`: This library is used for interacting with the Vulners Database API to search for vulnerabilities.(needs api token which you can get from their site with 100 credit for free)
    ```python
    ...
    (needs api token which you can get from their site for free)
